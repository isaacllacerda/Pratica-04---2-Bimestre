...
describe('Testes da classe Aluno', () => {
  ...
  const Aluno = require('./Aluno');
    ...
    test('calcularMedia deve lançar erro se uma das notas for maior que 10', () => {
    ...
    test('calcularMedia deve lançar erro se uma das notas não for número', () => {
    ...
    test('statusAprovacao deve retornar "aprovad@" se o aluno faltar uma prova, mas tirar nota máxima na outra', () => {
    ...
    describe('Testes da classe Aluno', () => {
      ...
      test('statusAprovacao deve retornar "aprovad@" para média entre 5 e 7', () => {
        aluno = new Aluno('Bruna', [6, 5]);
        expect(aluno.statusAprovacao()).toBe('aprovad@');
      });
    
      // 20. Testar se aluno com notas abaixo de 5 é reprovado
      test('statusAprovacao deve retornar "reprovad@" para média abaixo de 5', () => {
